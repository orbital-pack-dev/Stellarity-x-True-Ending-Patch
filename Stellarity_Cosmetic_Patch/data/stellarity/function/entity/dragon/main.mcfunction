...
#
# Совместимость с True Ending:
# 1. Пропуск клонов дракона (trueEnding_mirrordragon).
# 2. Кристаллы: nbt={ShowBottom:1b} (только башенные).
# 3. Не сбрасывать DragonPhase на 0, пока активны фазы True Ending.
# =====================================================================
