...
# Базовое фиолетовое свечение снаружи яйца
execute positioned ~0.5 ~0.5 ~0.5 run particle minecraft:dust_color_transition{from_color:[0.3,0.0,0.5],scale:0.7,to_color:[0.6,0.1,0.7]} ~ ~ ~ 0.4 0.4 0.4 0.01 4 force
execute positioned ~0.5 ~0.5 ~0.5 run particle minecraft:end_rod ~ ~ ~ 0.4 0.4 0.4 0.011 2 force
