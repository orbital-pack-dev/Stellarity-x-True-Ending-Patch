...
execute as @e[type=marker,tag=ste_cos_guard_marker_new,distance=..1,limit=1] if score #rng_ticker ste_cos.flags matches 0..4 run scoreboard players set @s ste_cos.orbit_y 5
execute as @e[type=marker,tag=ste_cos_guard_marker_new,distance=..1,limit=1] if score #rng_ticker ste_cos.flags matches 5..9 run scoreboard players set @s ste_cos.orbit_y 10
execute as @e[type=marker,tag=ste_cos_guard_marker_new,distance=..1,limit=1] if score #rng_ticker ste_cos.flags matches 10..14 run scoreboard players set @s ste_cos.orbit_y 15
execute as @e[type=marker,tag=ste_cos_guard_marker_new,distance=..1,limit=1] if score #rng_ticker ste_cos.flags matches 15..19 run scoreboard players set @s ste_cos.orbit_y 25
execute as @e[type=marker,tag=ste_cos_guard_marker_new,distance=..1,limit=1] if score #rng_ticker ste_cos.flags matches 20..24 run scoreboard players set @s ste_cos.orbit_y 35
