...
execute if score @s trueEnding_bosstime matches 1020 run summon ender_dragon ~12 ~128 ~10 {Tags:["trueEnding_mirrordragon"],NoAI:1b,Silent:1b,Invulnerable:1b}

# Вторая копия (bosstime 1050) — слева, высоко
execute if score @s trueEnding_bosstime matches 1050 run summon ender_dragon ~-12 ~128 ~10 {Tags:["trueEnding_mirrordragon"],NoAI:1b,Silent:1b,Invulnerable:1b}
