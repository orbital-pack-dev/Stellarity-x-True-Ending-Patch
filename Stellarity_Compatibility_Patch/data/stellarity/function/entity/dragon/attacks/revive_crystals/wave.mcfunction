# волна частиц при призыве кристаллов
...
execute unless score #wave stellarity.misc matches 72.. rotated ~5 ~ run function stellarity:entity/dragon/attacks/revive_crystals/wave
