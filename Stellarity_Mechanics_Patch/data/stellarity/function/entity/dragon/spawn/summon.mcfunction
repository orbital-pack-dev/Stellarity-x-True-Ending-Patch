...
execute if score #ste_cos_totem_used ste_cos.flags matches 1 run item replace entity @e[type=ender_dragon,tag=stellarity.ender_dragon] weapon.offhand with air
