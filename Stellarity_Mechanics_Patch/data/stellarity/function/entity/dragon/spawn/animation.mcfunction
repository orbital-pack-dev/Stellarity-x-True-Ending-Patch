...
execute if score @s stellarity.dragon.respawn_animation_progress matches 1 run scoreboard players set #stellarity.config stellarity.config.enable_dragon_screenshake 0
