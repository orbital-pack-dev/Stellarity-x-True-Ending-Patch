...
execute in minecraft:the_end positioned 0 65 0 as @e[type=end_crystal,distance=25..400,tag=!stellarity.respawn_crystal,tag=!ste_cos_portal_fix] at @s run function stellarity:entity/dragon/spawn/crystal_transitions/cancel
