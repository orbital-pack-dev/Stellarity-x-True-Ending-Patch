...
execute unless entity @s[tag=ste_cos.shielded_crystal] run data modify entity @s Glowing set value 0b
execute unless entity @s[tag=ste_cos.shielded_crystal] run team leave @s
