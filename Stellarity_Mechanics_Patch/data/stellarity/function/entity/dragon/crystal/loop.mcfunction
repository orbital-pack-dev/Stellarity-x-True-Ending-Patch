...
execute if score @s ste_cos.aura_tick matches 4 8 12 16 20 24 run particle dust_color_transition{from_color:[0.4,0.85,1.0],scale:0.9,to_color:[0.7,0.1,0.9]} ~ ~1.2 ~ 0.2 0.25 0.2 0.01 2 force @a[distance=..96]
