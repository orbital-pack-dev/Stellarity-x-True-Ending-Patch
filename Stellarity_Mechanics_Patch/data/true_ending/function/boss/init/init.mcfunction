...
execute store result score @s trueEnding_health_max run attribute @s max_health get
execute unless score @s trueEnding_health_max matches 1.. store result score @s trueEnding_health_max run attribute @s minecraft:max_health get
execute unless score @s trueEnding_health_max matches 1.. store result score @s trueEnding_health_max run attribute @s generic.max_health get
execute unless score @s trueEnding_health_max matches 1.. store result score @s trueEnding_health_max run attribute @s minecraft:generic.max_health get
