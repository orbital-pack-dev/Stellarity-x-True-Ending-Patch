...
execute as @s[predicate=!true_ending:condition/dragonphase_perched] if score #ste_cos_crystals ste_cos.flags matches 1.. run data modify entity @s Invulnerable set value 1b
execute as @s if score #ste_cos_crystals ste_cos.flags matches 0 run data modify entity @s Invulnerable set value 0b
