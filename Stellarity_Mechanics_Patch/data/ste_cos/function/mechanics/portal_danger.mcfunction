...
execute if score #wave_timer ste_cos.flags matches 20.. positioned -5 60 -5 as @a[dx=10,dy=250,dz=10,gamemode=!spectator,gamemode=!creative] run damage @s 2 magic by @e[type=ender_dragon,tag=stellarity.ender_dragon,limit=1]
