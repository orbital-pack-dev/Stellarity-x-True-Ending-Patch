...
execute at @e[type=arrow,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
...
execute at @e[type=spectral_arrow,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
kill @e[type=spectral_arrow,distance=..3.5]

# 3. Снежки, жемчуг Края, яйца, заряды ветра
execute at @e[type=snowball,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
kill @e[type=snowball,distance=..3.5]

execute at @e[type=ender_pearl,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
kill @e[type=ender_pearl,distance=..3.5]

execute at @e[type=egg,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
kill @e[type=egg,distance=..3.5]

execute at @e[type=wind_charge,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
kill @e[type=wind_charge,distance=..3.5]

execute at @e[type=breeze_wind_charge,distance=..3.5] run playsound item.shield.block hostile @a ~ ~ ~ 16.0 1.2
