...
execute in minecraft:the_end positioned 0 65 0 as @e[type=end_crystal,distance=15..300] unless data entity @s {beam_target:[I;0,67,0]} run data modify entity @s beam_target set value [I;0,67,0]
