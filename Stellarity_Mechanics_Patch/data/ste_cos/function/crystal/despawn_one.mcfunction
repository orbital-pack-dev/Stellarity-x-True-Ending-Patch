...
playsound minecraft:block.amethyst_block.resonate block @a ~ ~ ~ 32.0 0.65
playsound minecraft:entity.illusioner.mirror_move block @a ~ ~ ~ 32.0 0.60
playsound minecraft:block.respawn_anchor.deplete block @a ~ ~ ~ 32.0 0.55
