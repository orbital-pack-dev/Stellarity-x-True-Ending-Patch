...
playsound entity.shulker.teleport master @a -14 85 24.25 2.0 0.8
playsound entity.illusioner.prepare_mirror master @a -14 85 24.25 2.0 1.0
playsound entity.ender_dragon.growl master @a -14 85 24.25 2.0 1.1
