...
summon marker 0 128 0 {Tags:["ste_cos.carousel_center"]}

# звуки и визуальный взрыв призыва копий
playsound entity.shulker.teleport master @a 0 128 0 64.0 0.8
playsound entity.illusioner.prepare_mirror master @a 0 128 0 64.0 1.0
playsound entity.ender_dragon.growl master @a 0 128 0 64.0 1.1
particle flash{color:[0.85,0.25,1.0,1.0]} 0 128 0 0 0 0 0 2 force
