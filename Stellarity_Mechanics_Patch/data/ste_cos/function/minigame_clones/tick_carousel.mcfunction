...
# звуки взмахов крыльев (каждые 15 тиков)
scoreboard players add #carousel_flap ste_cos.timer 1
execute if score #carousel_flap ste_cos.timer matches 15.. run playsound entity.ender_dragon.flap hostile @a 0 128 0 32.0 1.0
