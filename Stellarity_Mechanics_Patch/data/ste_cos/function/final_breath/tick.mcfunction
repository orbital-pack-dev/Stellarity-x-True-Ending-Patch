...
# Когда подлетает в радиус 16 блоков от 0 67 0 — начинается анимированный взлет
...
# Состояние 2: Плавный взлет дракона от портала к высоте 79
execute if score #final_breath_state ste_cos.flags matches 2 run function ste_cos:final_breath/tick_ascend

# Состояние 3: 7-секундная кинематографичная зарядка на высоте 79 и залп
