...
execute as @a at @s run particle flash{color:-4980481} ~ ~1 ~ 0 0 0 0 1 force @s
execute as @a at @s run particle dust{color:[0.12,0.0,0.22],scale:4.0} ^ ^ ^1 0.1 0.1 0.1 0 45 force @s
