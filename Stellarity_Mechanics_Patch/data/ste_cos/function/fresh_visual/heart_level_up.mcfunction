...
# кулдаун 60 тиков для обычного сердцебиения (чтобы звук луча и стук сердца не накладывались)
...
execute as @e[type=marker,tag=ste_cos.respawn_heart,limit=1] at @s run particle flash ~ ~ ~ 0 0 0 0 1 force @a
