...
# призыв 3D-модели Сердца Дракона в точке 0 128.2 0 и запуск анимации
...
summon marker 0 128.2 0 {Tags:["ste_cos.respawn_heart","ste_cos.visual_marker"]}

# спавн 3D модели BDEngine ровно в координатах 0 128.2 0 с белым свечением
execute positioned 0 128.2 0 run function project:_/create
...
particle dust_color_transition{from_color:[0.65,0.05,0.95],scale:2.5,to_color:[0.15,0.0,0.35]} 0 128.2 0 0.8 0.8 0.8 0.05 30 force @a
particle dragon_breath 0 128.2 0 0.5 0.5 0.5 0.02 18 force @a
