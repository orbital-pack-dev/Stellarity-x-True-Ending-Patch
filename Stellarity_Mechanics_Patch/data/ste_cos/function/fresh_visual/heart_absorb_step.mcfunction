...
# когда маркер долетает до дракона (дистанция <= 4.0) или по истечении 160 тиков (8 сек)
...
execute if entity @e[type=ender_dragon,tag=stellarity.ender_dragon,distance=..4.0,limit=1] run playsound entity.warden.heartbeat hostile @a ~ ~ ~ 32.0 1.5
