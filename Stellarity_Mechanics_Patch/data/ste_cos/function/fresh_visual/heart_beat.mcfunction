...
# звук стука сердца (глубокий и медленный стук Вардена с громкостью 64 на весь остров)
execute if score #heart_stage ste_cos.flags matches 0 run playsound entity.warden.heartbeat hostile @a ~ ~ ~ 64.0 0.55
execute if score #heart_stage ste_cos.flags matches 1..3 run playsound entity.warden.heartbeat hostile @a ~ ~ ~ 64.0 0.60
execute if score #heart_stage ste_cos.flags matches 4..6 run playsound entity.warden.heartbeat hostile @a ~ ~ ~ 64.0 0.65
execute if score #heart_stage ste_cos.flags matches 7..9 run playsound entity.warden.heartbeat hostile @a ~ ~ ~ 64.0 0.70
execute if score #heart_stage ste_cos.flags matches 10.. run playsound entity.warden.heartbeat hostile @a ~ ~ ~ 64.0 0.75
...
execute if score #heart_stage ste_cos.flags matches 7.. run playsound block.amethyst_block.resonate hostile @a ~ ~ ~ 48.0 0.55
...
execute if score #heart_stage ste_cos.flags matches 10.. run playsound entity.warden.sonic_boom hostile @a ~ ~ ~ 48.0 0.65
