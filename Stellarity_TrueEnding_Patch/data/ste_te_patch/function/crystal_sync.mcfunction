# =====================================================================
# ste_te_patch:crystal_sync (v2.1 Bug Fixes)
# =====================================================================
...
# Синхронизация $crystals_gone для новой логики
execute if entity @e[type=end_crystal] run scoreboard players set $crystals_gone ste_te_flags 0
execute unless entity @e[type=end_crystal] run scoreboard players set $crystals_gone ste_te_flags 1
...
# ---------- СИГНАЛ СБРОСА ЩИТА ----------
execute in minecraft:the_end as @e[type=ender_dragon,tag=stellarity.ender_dragon,tag=!ste_te_crystals_gone,limit=1] at @s if score $crystals_gone ste_te_flags matches 1 run function ste_te_patch:crystal_shield_drop
